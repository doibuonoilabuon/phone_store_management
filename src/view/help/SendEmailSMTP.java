...
public class SendEmailSMTP {
    ...
    public static void sendOTP(String emailTo, String otp) {
        String username = "nhom5cvodich@gmail.com";
        String password = "bdln hkco itmn eehg";
...
"                    <a href=\"#\" style=\"font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600\">BaKyno1</a>" +
"                </div>" +
...
"                    <p>Số 3 phố Cầu Giấy, Phường Láng, TP. Hà Nộ</p>" +
"                    <p>Việt Nam</p>" +
"                </div>" +
"                </div>" +
